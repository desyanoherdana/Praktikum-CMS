...
<head>
    ...
    <title>Category - Sneakers Vault</title>
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex justify-between h-16 items-center">
                ...
                <div class="flex items-center space-x-6">
                    ...
                    <a href="{{ route('public.categories') }}" class="text-sm font-bold text-blue-600">Category</a>
    ...
    <main class="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div class="mb-8">
            <h1 class="text-3xl font-black text-gray-900 tracking-tight flex items-center gap-2">
                <span>🗂️</span> Kategori Aktivitas & Gaya
            </h1>
            <p class="text-gray-500 text-sm mt-1">Klasifikasi tipe penggunaan produk sneakers.</p>
        </div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div class="bg-white p-6 rounded-xl shadow-sm border border-gray-200 flex flex-col justify-between items-start hover:shadow-md transition">
                <div>
                    <span class="text-xs font-bold text-gray-400 uppercase tracking-wider">STYLE CATEGORY</span>
                    <h3 class="font-black text-gray-950 text-xl mt-1">{{ $category->nama_kategori }}</h3>
                </div>
                <div class="mt-4">
                    <span class="bg-emerald-50 text-emerald-600 px-3 py-1 rounded-full text-xs font-bold">
                        {{ $category->products_count }} Seri Sepatu
                    </span>
                </div>
            </div>
            @empty
            <div class="col-span-3 text-center py-16 bg-white rounded-xl border border-dashed border-gray-300">
                ...
                <p class="text-gray-400 text-sm font-medium">Belum ada data kategori tersedia.</p>
            </div>
            @endforelse
        </div>
    </main>
